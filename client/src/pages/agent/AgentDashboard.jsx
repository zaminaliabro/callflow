  ...
  return (
    <>
      ...
      <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
        ...
        <StatCard label="Calls Today" value={number(stats.todayCalls)} sub={`${number(stats.monthCalls)} this month`} icon="📞" accent="brand" />
        <StatCard
      ...
      {stats.target > 0 && (
        <div className="mt-4 card p-5">
          <div className="mb-2 flex justify-between text-sm">
            <span className="font-semibold text-slate-700">Monthly target progress</span>
      ...
      <div className="mt-4 grid gap-4 lg:grid-cols-3">
        <div className="card p-5 lg:col-span-2">
          <h2 className="mb-3 font-semibold text-slate-900">My sales — last 30 days</h2>
          <SalesChart data={series} metric="sales" />
        </div>

        <div className="card p-5">
          <h2 className="mb-3 font-semibold text-slate-900">🔔 Upcoming follow-ups</h2>
          <ul className="space-y-3">
            ...
            {followUps.length === 0 && (
              <p className="text-sm text-slate-500">Nothing due in the next few days.</p>
            )}
          </ul>
        </div>
      </div>
      ...
      <div className="mt-4 card">
        <div className="border-b border-slate-200 px-5 py-4">
          <h2 className="font-semibold text-slate-900">My recent calls</h2>
        </div>
